...
class MeasurementProvider with ChangeNotifier {
  ...
  /// Currently there isn't any fallback if the call to the api is unsuccessful, as werkautBaseProvider.patch only returns the response body and not the whole response
  ...
  /// werkautBaseProvider.patch only returns the response body and not the whole response
