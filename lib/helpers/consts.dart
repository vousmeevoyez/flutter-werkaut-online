...
/// Default werkaut server during login
const DEFAULT_SERVER = 'https://werkaut.online';

/// Keys used in the android manifest
const MANIFEST_KEY_API = 'werkaut.api_key';
const MANIFEST_KEY_CHECK_UPDATE = 'werkaut.check_min_app_version';
