...
import 'package:werkaut/helpers/gym_mode.dart';
                            ...
                            children: [
                              ...
                              Container(
                                decoration: const BoxDecoration(
                                  color: werkautPrimaryColorLight,
        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: Theme.of(context).textTheme.headline1!.copyWith(color: werkautPrimaryColor),
            ),
          ),
        ),
        NavigationFooter(widget._controller, widget._ratioCompleted),
      ...
      children: [
        ...
        Expanded(
          child: LinearProgressIndicator(
            ...
            valueColor: const AlwaysStoppedAnimation<Color>(werkautPrimaryColor),
          ),
        ),
        if (showNext)
          IconButton(
