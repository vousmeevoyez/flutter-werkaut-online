  ...
  group('test gallery provider', () {
    test('Test that fetch and set gallery', () async {
      ...
      when(client.get(
        ...
        headers: anyNamed('headers'),
          ...
          '{"id":58,'
          '"date":"2022-01-09",'
          '"image":"https://werkaut.online/media/gallery/170335/d2b9c9e0-d541-41ae-8786-a2ab459e3538.jpg",'
    ...
    test('Test that delete gallery photo', () async {
      ...
      final image = gallery.Image(
          ...
          url: 'https://werkaut.online/media/gallery/170335/d2b9c9e0-d541-41ae-8786-a2ab459e3538.jpg',
          description: "eggsaddjujuit\'ddayhadIforcanview");
